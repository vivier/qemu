...
#if defined(TARGET_NR_semctl) || defined(TARGET_NR_msgctl) || defined(TARGET_NR_shmctl)
...
#if defined(TARGET_NR_shmat) || defined(TARGET_NR_ipc)
SYSCALL_IMPL(shmat)
{
    int shmid = arg1;
...
static const struct SyscallDef def_semop, def_semget, def_semctl, def_msgget,
                               def_msgsnd, def_msgctl, def_msgrcv, def_shmdt,
                               def_shmget, def_shmctl;
